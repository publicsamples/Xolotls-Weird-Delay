...
Compilation options: -lang cpp -rui -cn _khp -scn ::faust::dsp -es 1 -mcd 16 -uim -single -ftz 0
------------------------------------------------------------ */
...
class _khp final : public ::faust::dsp {
 ...
 public:
	...
	void metadata(Meta* m) { 
		...
		m->declare("compile_options", "-lang cpp -rui -cn _khp -scn ::faust::dsp -es 1 -mcd 16 -uim -single -ftz 0");
	...
	void compute(int count, FAUSTFLOAT** RESTRICT inputs, FAUSTFLOAT** RESTRICT outputs) {
		...
		for (int i0 = 0; i0 < count; i0 = i0 + 1) {
			...
			float fTemp6 = 1.0f - fSlow1 * (fTemp1 * (1.0f - fTemp4) / fTemp3);
			float fTemp7 = (fTemp0 - (fRec3[1] + (fTemp2 - fRec1[1] - fRec2[1] * fTemp5) / fTemp3)) / fTemp6;
			float fRec0 = fTemp7;
			float fTemp8 = fSlow1 * fTemp7;
			float fTemp9 = fTemp1 * (fTemp8 - fRec2[1]) / fTemp3;
			fRec1[0] = fRec1[1] + 2.0f * (fTemp1 * (fTemp8 - (fTemp9 + fRec1[1] + fRec2[1])) / fTemp3);
			fRec2[0] = fRec2[1] + 2.0f * fTemp9;
			fRec3[0] = fRec3[1] + 2.0f * (fTemp2 / fTemp3);
			output0[i0] = FAUSTFLOAT(fRec0);
			float fTemp10 = float(input1[i0]);
			float fTemp11 = fTemp1 * (fTemp10 - fRec8[1]);
			float fTemp12 = (fTemp10 - (fRec8[1] + (fTemp11 - fRec6[1] - fTemp5 * fRec7[1]) / fTemp3)) / fTemp6;
			float fRec5 = fTemp12;
			float fTemp13 = fSlow1 * fTemp12;
			float fTemp14 = fTemp1 * (fTemp13 - fRec7[1]) / fTemp3;
			fRec6[0] = fRec6[1] + 2.0f * (fTemp1 * (fTemp13 - (fTemp14 + fRec6[1] + fRec7[1])) / fTemp3);
			fRec7[0] = fRec7[1] + 2.0f * fTemp14;
			fRec8[0] = fRec8[1] + 2.0f * (fTemp11 / fTemp3);
	...
	#define FAUST_COMPILATION_OPIONS "-lang cpp -rui -cn _khp -scn ::faust::dsp -es 1 -mcd 16 -uim -single -ftz 0"
