...
Compilation options: -lang cpp -rui -cn _granular -scn ::faust::dsp -es 1 -mcd 16 -uim -single -ftz 0
------------------------------------------------------------ */
...
class _granular final : public ::faust::dsp {
 ...
 public:
	...
	void metadata(Meta* m) { 
		...
		m->declare("compile_options", "-lang cpp -rui -cn _granular -scn ::faust::dsp -es 1 -mcd 16 -uim -single -ftz 0");
	...
	void compute(int count, FAUSTFLOAT** RESTRICT inputs, FAUSTFLOAT** RESTRICT outputs) {
		...
		float fSlow4 = std::max<float>(0.125f, std::min<float>(4.0f, float(fHslider4)));
		float fSlow5 = 1e+03f / fSlow2;
		float fSlow6 = 0.33333334f * float(iSlow3);
		float fSlow7 = fSlow6 + 1e+01f;
		float fSlow8 = 0.33333334f * float(2 * iSlow3);
		...
		for (int i0 = 0; i0 < count; i0 = i0 + 1) {
			...
			float fThen2 = fRec5[0] + fRec3[1];
			float fElse2 = float(fRec5[0] < 0.0f);
			fRec3[0] = std::max<float>(0.0f, ((iTemp1) ? fElse2 : fThen2));
			...
			float fThen5 = fRec7[1] + fTemp3;
			float fElse5 = float(fTemp3 < 0.0f);
			fRec7[0] = std::max<float>(0.0f, ((iTemp1) ? fElse5 : fThen5));
			float fTemp4 = std::cos(6.2831855f * ((fRec7[0] > 1.0f) ? 0.0f : fRec7[0]) + 3.1415927f) + 1.0f;
			float fTemp5 = float(iRec4[0]);
			int iElse8 = ((fTemp5 > fSlow6) ? 1 : 0);
			int iTemp6 = ((fTemp5 < fSlow7) ? iElse8 : 0);
			iVec1[0] = iTemp6;
			int iTemp7 = iTemp6 > iVec1[1];
			fRec10[0] = ((iTemp7) ? fSlow4 : fRec10[1]);
			float fThen10 = fRec10[0] + fRec9[1];
			float fElse10 = float(fRec10[0] < 0.0f);
			fRec9[0] = std::max<float>(0.0f, ((iTemp7) ? fElse10 : fThen10));
			...
			float fThen13 = fRec12[1] + fTemp9;
			float fElse13 = float(fTemp9 < 0.0f);
			fRec12[0] = std::max<float>(0.0f, ((iTemp7) ? fElse13 : fThen13));
			float fTemp10 = std::cos(6.2831855f * ((fRec12[0] > 1.0f) ? 0.0f : fRec12[0]) + 3.1415927f) + 1.0f;
			int iElse16 = ((fTemp5 > fSlow8) ? 1 : 0);
			int iTemp11 = ((fTemp5 < fSlow9) ? iElse16 : 0);
			iVec2[0] = iTemp11;
			int iTemp12 = iTemp11 > iVec2[1];
			fRec15[0] = ((iTemp12) ? fSlow4 : fRec15[1]);
			float fThen18 = fRec15[0] + fRec14[1];
			float fElse18 = float(fRec15[0] < 0.0f);
			fRec14[0] = std::max<float>(0.0f, ((iTemp12) ? fElse18 : fThen18));
			iRec16[0] = ((iTemp12) ? iRec2[0] : iRec16[1]);
			int iTemp13 = (iSlow1 + int(fRec14[0]) + iRec16[0]) % 44100;
			fRec18[0] = ((iTemp12) ? fSlow5 : fRec18[1]);
			float fTemp14 = fConst4 * fRec18[0];
			float fThen21 = fRec17[1] + fTemp14;
			float fElse21 = float(fTemp14 < 0.0f);
			fRec17[0] = std::max<float>(0.0f, ((iTemp12) ? fElse21 : fThen21));
			float fTemp15 = std::cos(6.2831855f * ((fRec17[0] > 1.0f) ? 0.0f : fRec17[0]) + 3.1415927f) + 1.0f;
			int iTemp16 = ((iRec4[0] > iSlow10) ? 1 : 0);
			iVec3[0] = iTemp16;
			int iTemp17 = iTemp16 > iVec3[1];
			fRec20[0] = ((iTemp17) ? fSlow4 : fRec20[1]);
			float fThen25 = fRec20[0] + fRec19[1];
			float fElse25 = float(fRec20[0] < 0.0f);
			fRec19[0] = std::max<float>(0.0f, ((iTemp17) ? fElse25 : fThen25));
			iRec21[0] = ((iTemp17) ? iRec2[0] : iRec21[1]);
			int iTemp18 = (iSlow1 + int(fRec19[0]) + iRec21[0]) % 44100;
			fRec23[0] = ((iTemp17) ? fSlow5 : fRec23[1]);
			float fTemp19 = fConst4 * fRec23[0];
			float fThen28 = fRec22[1] + fTemp19;
			float fElse28 = float(fTemp19 < 0.0f);
			fRec22[0] = std::max<float>(0.0f, ((iTemp17) ? fElse28 : fThen28));
			float fTemp20 = std::cos(6.2831855f * ((fRec22[0] > 1.0f) ? 0.0f : fRec22[0]) + 3.1415927f) + 1.0f;
			float fTemp21 = ftbl0[iTemp2] * fTemp4 + ftbl0[iTemp8] * fTemp10 + ftbl0[iTemp13] * fTemp15 + ftbl0[iTemp18] * fTemp20;
			fVec4[0] = fTemp21;
	...
	#define FAUST_COMPILATION_OPIONS "-lang cpp -rui -cn _granular -scn ::faust::dsp -es 1 -mcd 16 -uim -single -ftz 0"
